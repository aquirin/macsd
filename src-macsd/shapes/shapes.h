...
class shapes {
    public:
        ...
        shapes(const string & name, const vector<string> & shap, const vector<string> & link, const map<pair<string,string>, string> & rn);
	...
	const string inicial() const {return "object";};
