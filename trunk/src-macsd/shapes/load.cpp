...
//                 200858_s_at|6412/protein biosynthesis/evidence IEA|3735/structural constituent of ribosome/evidence IEA|5840/ribosome/evidence IEA@5622/intracellular/evidence IEA|20
			...
			if (ww.find(cadena.substr(aux + 1, aux1 - aux - 1)) != ww.end())
			  cout << cadena.substr(aux + 1, aux1 - aux - 1) << " TRUE" << endl;
			else
			  cout << cadena.substr(aux + 1, aux1 - aux - 1) << " FALSE" << endl;
...
/*
    ...
    */
    ...
    int kk;
    for (unsigned int i = 0; i < misub.size(); i++) {
